...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: Claude API reference — TypeScript |
| 分类 | Data → API 参考 |
| 文件路径 | `system-prompts/data-claude-api-reference-typescript.md` |
| CC 版本 | 2.1.83 |
| 模板变量 | 无 |

## 概述

TypeScript SDK 参考，包含安装、客户端初始化、基本请求、思考模式和多轮对话。此文件共 338 行，主要作为 Claude Code 的内置参考数据。
