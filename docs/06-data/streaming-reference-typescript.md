...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: Streaming reference — TypeScript |
| 分类 | Data → SDK 参考 |
| 文件路径 | `system-prompts/data-streaming-reference-typescript.md` |
| CC 版本 | 2.1.78 |
| 模板变量 | 无 |

## 概述

TypeScript 流式传输参考，包含基本流式传输和不同内容类型处理。此文件共 183 行，主要作为 Claude Code 的内置参考数据。
