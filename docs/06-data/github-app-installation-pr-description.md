...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: GitHub App installation PR description |
| 分类 | Data → GitHub 集成 |
| 文件路径 | `system-prompts/data-github-app-installation-pr-description.md` |
| CC 版本 | 2.0.14 |
| 模板变量 | 无 |

## 概述

安装 Claude Code GitHub App 集成时的 PR 描述模板。此文件共 46 行，主要作为 Claude Code 的内置参考数据。
