...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: GitHub Actions workflow for @claude mentions |
| 分类 | Data → GitHub 集成 |
| 文件路径 | `system-prompts/data-github-actions-workflow-for-claude-mentions.md` |
| CC 版本 | 2.0.58 |
| 模板变量 | 无 |

## 概述

GitHub Actions 工作流模板，用于通过 @claude 提及触发 Claude Code。此文件共 55 行，主要作为 Claude Code 的内置参考数据。
