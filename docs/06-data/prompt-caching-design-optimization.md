...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: Prompt Caching — Design & Optimization |
| 分类 | Data → 概念指南 |
| 文件路径 | `system-prompts/data-prompt-caching-design-optimization.md` |
| CC 版本 | 2.1.89 |
| 模板变量 | 无 |

## 概述

提示词缓存设计与优化指南，包含放置模式和反模式。此文件共 176 行，主要作为 Claude Code 的内置参考数据。
