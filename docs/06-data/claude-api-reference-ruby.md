...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: Claude API reference — Ruby |
| 分类 | Data → API 参考 |
| 文件路径 | `system-prompts/data-claude-api-reference-ruby.md` |
| CC 版本 | 2.1.83 |
| 模板变量 | 无 |

## 概述

Ruby SDK 参考，包含安装、客户端初始化、基本请求、流式传输和 beta 工具运行器。此文件共 118 行，主要作为 Claude Code 的内置参考数据。
