...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: HTTP error codes reference |
| 分类 | Data → API 参考 |
| 文件路径 | `system-prompts/data-http-error-codes-reference.md` |
| CC 版本 | 2.1.73 |
| 模板变量 | 无 |

## 概述

Claude API 返回的 HTTP 错误码参考，包含常见原因和处理策略。此文件共 211 行，主要作为 Claude Code 的内置参考数据。
