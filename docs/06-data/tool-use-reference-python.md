...
| 属性 | 值 |
|------|-----|
| 原始名称 | Data: Tool use reference — Python |
| 分类 | Data → SDK 参考 |
| 文件路径 | `system-prompts/data-tool-use-reference-python.md` |
| CC 版本 | 2.1.78 |
| 模板变量 | 无 |

## 概述

Python 工具使用参考，包含工具运行器、手动代理循环、代码执行和结构化输出。此文件共 595 行，主要作为 Claude Code 的内置参考数据。
